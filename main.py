# -*- coding: utf-8 -*-
"""
Created on Fri Mar  9 18:18:09 2018
...
plt.plot(losses['train'][20:], label='Training loss')
plt.plot(losses['validation'][20:], label='Validation loss')
plt.legend()
_ = plt.ylim()

# test the netork and plot results
